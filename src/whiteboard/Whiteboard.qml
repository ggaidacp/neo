...
EmbeddedWindow {
    ...
    property string oldTool: "pencil"
    ...
    Component.onCompleted: {
        // Save the clear canvas as first entry into the history
        history[0] = canvas.toDataURL()
        //embeddedWindow.prese
        Settings.onIsPresentationModeChanged.connect(onPresModeChange)
        Settings.whiteboard = embeddedWindow
    }
    ...
    Connections {
        ...
        onCurrentIndexChanged: {
            if (Settings.embeddedWindow.currentIndex === 5) {
                ...
                Settings.contentArea = canvasBackground
            }
        }
    }
            ...
            Rectangle {
                ...
                Canvas {
                    ...
                    onImageLoaded: {
                        ...
                        ctx.drawImage(history[position], 0, 0, canvas.width,
                                      canvas.height)
                    }
        ...
        Rectangle {
            ...
            Row {
                ...
                Image {
                    ...
                    source: (tool == "pencil") ? "qrc:/images/whiteboard/pencil_gold.png" : "qrc:/images/whiteboard/pencil.png"
                    fillMode: Image.PreserveAspectFit
                    mipmap: true
                    anchors.verticalCenter: parent.verticalCenter
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            if (!buttonPencil.isClicked) {
                                ...
                                buttonLaserPointer.isClicked = false
                                tool = "pencil"
                                ctx.lineWidth = 1
                ...
                Image {
                    ...
                    width: 32 //parent.width / 12
                    height: 32 //parent.height / 2
                    source: (tool == "eraser") ? "qrc:/images/whiteboard/eraser_gold.png" : "qrc:/images/whiteboard/eraser.png"
                    fillMode: Image.PreserveAspectFit
                    mipmap: true
                    anchors.verticalCenter: parent.verticalCenter
                    property bool isClicked: false
                ...
                Image {
                    ...
                    width: 32 //parent.width / 12
                    height: 32 //parent.height / 2
                    source: (tool == "textField") ? "qrc:/images/whiteboard/text_gold.png" : "qrc:/images/whiteboard/text.png"
                    fillMode: Image.PreserveAspectFit
                    mipmap: true
                    anchors.verticalCenter: parent.verticalCenter
                    property bool isClicked: false
        ...
        Row {
            ...
            Row {
                ...
                Image {
                    ...
                    source: "qrc:/images/whiteboard/new.png"
                    fillMode: Image.PreserveAspectFit
                    mipmap: true
                    anchors.verticalCenter: parent.verticalCenter
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            textFieldBox.visible = false
                            root.enabled = false
                            popUpWindowNew.visible = true
                        }
                        onPressed: {
                            buttonNew.source = "qrc:/images/whiteboard/new_gold.png"
                        }
                        onReleased: {
                            buttonNew.source = "qrc:/images/whiteboard/new.png"
                        }
                    }
                }
                // button screenshot
    ...
    /*
      *
      * PopUpWindow for the new-button
      *
    */
    PopUpWindowWithTwoButtons {
        ...
        onCloseClicked: {
            popUpWindowNew.visible = false
            root.enabled = true
        }
        text: "Wollen Sie ein neues Whiteboard starten und alle Änderungen verwerfen?"
        onButton1Clicked: {
            popUpWindowNew.visible = false
            // Empty the canvas
            ...
            // Reset all tools to the start setting
            buttonPencil.isClicked = buttonPencil.isClicked ? false : true
            buttonMarker.isClicked = false
            buttonText.isClicked = false
            buttonEraser.isClicked = false
            tool = "pencil"
