...
function webViewerInitialized() {
  ...
  PDFViewerApplication.isWebViewerInitialized = true
}
...
function qpdf_ShowPdfFileBase64(b64Data) {
	if (PDFViewerApplication.isDocumentLoaded || !PDFViewerApplication.isWebViewerInitialized)
		return;
	PDFViewerApplication.isDocumentLoaded = true;
